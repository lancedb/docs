---
title: Advanced Execution Contexts
sidebarTitle: Advanced execution contexts
description: Configure the distributed execution backend — clusters and dependency manifests — for Geneva jobs on object-storage and local-filesystem connections.
icon: circle-nodes
---
