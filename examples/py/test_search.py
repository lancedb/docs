...
# --8<-- [start:import-numpy-search]
from lancedb.query import BoostQuery, MatchQuery
import numpy as np
import pyarrow as pa

# --8<-- [end:import-numpy-search]
# --8<-- [start:import-datetime-search]
from datetime import datetime

# --8<-- [end:import-datetime-search]
# --8<-- [start:import-lancedb-pydantic-search]
from lancedb.pydantic import Vector, LanceModel

# --8<-- [end:import-lancedb-pydantic-search]
# --8<-- [start:import-pydantic-base-model-search]
from pydantic import BaseModel

# --8<-- [end:import-pydantic-base-model-search]
# --8<-- [start:import-lancedb-fts-search]
from lancedb.index import FTS

# --8<-- [end:import-lancedb-fts-search]
# --8<-- [start:import-os-search]
import os

# --8<-- [end:import-os-search]
# --8<-- [start:import-embeddings-search]
from lancedb.embeddings import get_registry

# --8<-- [end:import-embeddings-search]
import pytest
