...
def test_ann_index():
    ...
    # --8<-- [start:vector_search_guide_index]
    tbl.search(np.random.random((32))).limit(2).nprobes(20).refine_factor(
        10
    ).to_pandas()
    # --8<-- [end:vector_search_guide_index]
    # --8<-- [start:vector_search_with_filter_guide_index]
    tbl.search(np.random.random((32))).where("item != 'item 1141'").to_pandas()
    # --8<-- [end:vector_search_with_filter_guide_index]
    # --8<-- [start:vector_search_with_select_guide_index]
    tbl.search(np.random.random((32))).select(["vector"]).to_pandas()
    # --8<-- [end:vector_search_with_select_guide_index]
...
async def test_ann_index_async():
    ...
    # --8<-- [start:vector_search_async_guide_index]
    await (
    ...
    # --8<-- [end:vector_search_async_guide_index]
