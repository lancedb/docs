...
# --8<-- [start:make_batches_guide_tables]
def make_batches():
    for i in range(5):
...
# --8<-- [end:make_batches_guide_tables]


# --8<-- [start:make_batches_for_add_guide_tables]
...
# --8<-- [end:make_batches_for_add_guide_tables]
...
def my_table():
    ...
    db.create_table("my_table", data, exist_ok=True)
    ...
    tbl = db.create_table("my_table", data, mode="overwrite")
