...
sidebarTitle: FTS with SQL
description: Use LanceDB's full-text search capabilities via SQL queries.
icon: "book"
---
...
### Creating FTS Index {#creating-fts-index}
...
#### Phrase Queries with Slop {#phrase-queries-with-slop}
...
### Multi-Match Queries {#multi-match-queries}
...
#### Multi-Match with Field Boosting {#multi-match-with-field-boosting}
...
## Combining FTS with SQL {#combining-fts-with-sql}
