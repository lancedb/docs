...
- Create ANN index on your vector column(s) as described in the [index guide](/user-guides/indexing/vector-index/)
- If you often filter by metadata, create [scalar indices](/user-guides/indexing/scalar-index/) on those columns
