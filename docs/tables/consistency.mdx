...
(LanceDB Cloud and <Badge color="red">Enterprise</Badge>) tables. It only affects read operations —
write operations are always consistent.

<Callout color="blue">
**Consistency in Remote Tables**

For remote tables (LanceDB Cloud and <Badge color="red">Enterprise</Badge>), `read_consistency_interval` is also
