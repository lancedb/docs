...
sorting, aggregations, joins, and so on by converting LanceDB tables to DuckDB tables.
...
search. See the [indexing](/indexings/) documentation for details on how to create and use
