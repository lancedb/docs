---
title: "Get started with LanceDB Cloud"
sidebarTitle: "Get started"
description: "Learn how to ingest data into LanceDB Cloud and run search, in just a few minutes."
icon: "rocket"
---
...
```ts TypeScript icon=js expandable=true
