...
import { PyQuickFixManifest, PyEnvVarsViaCluster, PyPipManifest, PyCondaManifestPath, PyCondaManifestInline } from '/snippets/geneva_dependency_verification.mdx';
...
**Option 3: Conda Manifest**

Use a conda environment on workers via the manifest builder:
