...
### [Checkpointing](/geneva/jobs/checkpointing/)
Understand how Geneva checkpoints batches and fragments to make distributed jobs restartable, incremental, and idempotent.
...
- **Checkpointing**: Resume jobs from failures without losing progress. See [Checkpointing](/geneva/jobs/checkpointing/).
