...
setup in this example. Set your connection details:

```python
import os

PHALANX_URI = os.getenv("PHALANX_URI")          # your LanceDB Enterprise endpoint
PHALANX_API_KEY = os.getenv("PHALANX_API_KEY")  # your API key
DB_URI = "db://my-db"                            # your database
```
...
db = geneva.connect(
    uri=DB_URI,
    host_override=os.getenv("PHALANX_URI"),
