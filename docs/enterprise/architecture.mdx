...
This design makes LanceDB Enterprise suitable for catalog-backed layouts, see [Namespaces and the Catalog Model](/management/namespace) for more details. For the basic application flow, see the shared [quickstart](/quickstart).
