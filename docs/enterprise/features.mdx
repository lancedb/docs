...
sidebarTitle: "Differentiating features"
description: "Key benefits and differentiating features of LanceDB Enterprise over LanceDB OSS."
---
...
Move to Lance DB Enterprise when you have petabyte-scale data, or you need latency to be below 200 ms, or you need higher query throughput towards thousands of QPS, or your business requires high availability, compliance controls, and vendor support.
