...
description: "An overview of the Lance format, an open source columnar file and table format that provides the foundation for LanceDB's multimodal capabilities and performance."
---

LanceDB is built on top of the [Lance](https://lance.org/) columnar data format, which provides the
