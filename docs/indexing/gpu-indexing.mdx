...
## Manual GPU indexing in LanceDB OSS {#manual-gpu-indexing-in-lancedb-oss}
...
### GPU indexing on Linux {#gpu-indexing-on-linux}
...
### GPU indexing on macOS (Apple Silicon) {#gpu-indexing-on-macos-apple-silicon}
