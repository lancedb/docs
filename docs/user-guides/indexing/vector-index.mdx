...
aliases:
  ...
  - "/docs/concepts/indexing/vector-index"
---
import VectorIndexConfigureIvf from '/snippets/py/vector_index_configure_ivf.mdx';
import VectorIndexSetup from '/snippets/py/vector_index_setup.mdx';
import VectorIndexBuildIvf from '/snippets/py/vector_index_build_ivf.mdx';
import VectorIndexQueryIvf from '/snippets/py/vector_index_query_ivf.mdx';
import VectorIndexBuildHnsw from '/snippets/py/vector_index_build_hnsw.mdx';
import VectorIndexQueryHnsw from '/snippets/py/vector_index_query_hnsw.mdx';
import VectorIndexBinarySchema from '/snippets/py/vector_index_binary_schema.mdx';
import VectorIndexBinaryAddData from '/snippets/py/vector_index_binary_add_data.mdx';
import VectorIndexBinaryBuildIndex from '/snippets/py/vector_index_binary_build_index.mdx';
import VectorIndexBinarySearch from '/snippets/py/vector_index_binary_search.mdx';
import VectorIndexCheckStatus from '/snippets/py/vector_index_check_status.mdx';
