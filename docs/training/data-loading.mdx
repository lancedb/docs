...
- **Batch size** - The number of rows processed by one GPU in a single training step (sometimes called a "minibatch" in machine learning literature). For example, $128$.
