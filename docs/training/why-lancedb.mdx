...
<CardGroup cols={2}>
  ...
  <Card title="Robotics with LeRobot" icon="robot" href="/integrations/lerobotdataset">
    Train LeRobot policies straight from object storage with a global shuffle, then curate and search the same tables.
  </Card>
</CardGroup>
