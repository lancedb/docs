...
AI and ML workloads built on top of the [Lance format](/lance), an open lakehouse format.
...
LanceDB is designed for a variety of workloads and deployment scenarios,
all built on top of the same open-source Lance format and table abstraction.
