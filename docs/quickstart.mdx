...
<Note>
The TypeScript SDK (`@lancedb/lancedb`) requires Node.js 22 or later. Earlier releases supported Node.js 18, but Node.js 18 and 20 are end-of-life. Upgrade your runtime before installing or updating the package.
</Note>
